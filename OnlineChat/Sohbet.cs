...
namespace OnlineChat
{
    public partial class Sohbet : Form
    {
        ...
        private static string sIp = "89.252.138.3"; // Sunucu IP Adresi
        private static string sDB = "pinkflo1_db2"; // Veritabanı
        private static string sKA = "pinkflo1_users"; // Kullanıcı Adı
        private static string sSifre = "pinkfloyd2000"; // Şifre
        ...
        private void Sohbet_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ftp.Credentials = new NetworkCredential("pinkflo1", "pinkfloyd2000");
                //richTextBox1.Text = ftp.DownloadString("ftp://pinkfloydchat.com//home/pinkflo1/public_ftp/Sohbet.txt");
                richTextBox1.Text = ftp.DownloadString("ftp://89.252.138.3/Sohbet.txt");
                timer1.Start();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ftp.Credentials = new NetworkCredential("pinkflo1", "pinkfloyd2000");
                ftp.UploadString("ftp://89.252.138.3/Sohbet.txt", richTextBox1.Text + "(" + saat + ":" + dakika + ":" + saniye + ")---" + kullanici_id + " : " + richTextBox2.Text + "\n");
