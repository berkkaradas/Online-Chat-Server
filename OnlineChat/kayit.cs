...
namespace OnlineChat
{
    public partial class kayit : Form
    {
        ...
        private void btn_devam_Click(object sender, EventArgs e)
        {
            ...
            onay.kullanici_vatandaslik = tb_vatandaslik.Text;
            ...
            else
            {
                ...
                mesaj.Subject = ("Pink Floyd Chat'e Hoşgeldin " + tb_ad.Text + "  " + tb_soyad.Text);
                mesaj.From = new MailAddress("pinkfloydchat@gmail.com");
                mesaj.To.Add(tb_epostanelirle.Text);
                mesaj.Body = ("Doğrulama Kodunuz :" + sb);

                SmtpClient server = new SmtpClient("smtp.gmail.com");
                server.Credentials = new System.Net.NetworkCredential("pinkfloydchat1@gmail.com", "1a2b3c4D");
                server.Port = 587;
