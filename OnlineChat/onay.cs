...
namespace OnlineChat
{
    public partial class onay : Form
    {
        ...
        public static string kullanici_vatandaslik { get; set; }
                ...
                if (rdr.Read())
                {
                    ...
                    if (mysqlbaglan.State != ConnectionState.Open)
                    {
                        ...
                        if (mysqlbaglan.State != ConnectionState.Open)
                        {
                            ...
                            komutVer1.CommandText = "INSERT INTO Users (KullaniciAdi,Parola,Adi,Soyadi,EPosta,Cinsiyet,Durum,Songorulme,Vatandaslik) VALUES(@isim,@sifre,@adi,@soyadi,@eposta,@cinsiyet,@durum,@songorulme,@Vatandaslik)";
                            ...
                            komutVer1.Parameters.AddWithValue("@Vatandaslik", kullanici_vatandaslik);
